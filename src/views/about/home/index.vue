...
@import '@/style/scss/mixins/mixins.scss';

@include b(about) {
  p {
    --at-apply: text-color-regular flex-y-center text-14px;
  }
}

.tag {
  --at-apply: text-primary bg-color-secondary text-12px p-y-2px p-x-8px rounded-6px ml-12px font-family-ali-regular;
}
</style>
